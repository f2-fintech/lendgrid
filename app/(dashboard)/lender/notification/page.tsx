...
export default function LenderNotificationPage() {
  const notifications = [
    { id: 1, message: "New loan request received 💼", time: "10 min ago" },
    { id: 2, message: "Payout approved ✅", time: "2 hr ago" },
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex justify-center items-start p-6">
      <Card className="bg-gray-800 border border-gray-700 shadow-lg w-full max-w-3xl">
        <CardHeader>
          <CardTitle className="text-white text-2xl">Lender Notifications</CardTitle>
        </CardHeader>
