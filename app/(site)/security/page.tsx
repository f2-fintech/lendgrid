  ...
  return (
    <main className="relative min-h-screen bg-gradient-to-b from-[#040d21] via-[#071227] to-[#081322] text-gray-100 antialiased pb-20">
      ...
      <div className="mx-auto mt-10 max-w-4xl space-y-6 px-4">
        <GlassCard className="p-6 bg-[#081327]/40 border border-gray-800">
        ...
        <GlassCard className="p-0 bg-[#081327]/40 border border-gray-800">
          <Accordion.Root type="multiple" className="w-full">
            {sections.map((s, i) => (
              <Accordion.Item key={i} value={`item-${i}`} className="border-b border-white/10">
                ...
                <Accordion.Content className="px-5 pb-5 text-sm text-gray-300">
                  {s.p}
                </Accordion.Content>
              </Accordion.Item>
            ))}
