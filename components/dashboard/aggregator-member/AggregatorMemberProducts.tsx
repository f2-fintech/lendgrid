...
export function AggregatorMemberProducts() {
  const { user } = useAuth('aggregator_member')
  ...
  console.log(allLenders, selectedLenderId, selectedProduct, 'this is all lenders', products)
