...
const mockData = {
  ...
  chartData: [
    { month: 'Jan', applications: 0, approvals: 0 },
    { month: 'Feb', applications: 0, approvals: 0 },
    { month: 'Mar', applications: 0, approvals: 0 },
    { month: 'Apr', applications: 0, approvals: 0 },
    { month: 'May', applications: 0, approvals: 0 },
    { month: 'Jun', applications: 0, approvals: 0 }
  ]
}
